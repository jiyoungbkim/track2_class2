			...
			<div class="grap">
				<form name="admin">
					<fieldset>
						...
						<input type="text" name="t_id" placeholder="아이디를 입력하세요" id="id" value="${t_dtoM.getId()}">
						...
						<input type="text" name="name" placeholder="이름을 입력하세요" id="name" value="${t_dtoM.getName()}">
						
						<label for="birth" class="sr-only">생년월일입력</label>
						<input type="text" name="birth" placeholder="생년월일을 입력하세요" id="birth" value="${t_dtoM.getBirth()}">
						...
						<input type="text" name="address" placeholder="주소를 입력하세요" id="address" value="${t_dtoM.getAddress()}">
						...
						<label for="telecom" class="sr-only">통신사입력</label>
							...
							&nbsp;<br>
							<input name="phone_1" type = "text" size = "1" maxlength="3" placeholder="000" id="phone" value="${t_dtoM.getPhone_1()}">&nbsp;-&nbsp;
							<input name="phone_2" type = "text" size = "3" maxlength="4" placeholder="0000" id="phone" value="${t_dtoM.getPhone_2()}">&nbsp;-&nbsp;
							<input name="phone_3" type = "text" size = "3" maxlength="4" placeholder="0000" id="phone" value="${t_dtoM.getPhone_3()}">
						
						<label for="email" class="sr-only">번호입력</label>
						<input type="text" name="email_1" placeholder="이메일 입력" id="email_1" value="${t_dtoM.getEmail_1()}">&nbsp;&#64;
						<input type="text" name="email_2" placeholder="이메일 주소를 입력하세요" id="email_2" value="${t_dtoM.getEmail_2()}">

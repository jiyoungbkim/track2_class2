...
public class News_DAO {
	...
	public String getMaxNo(){
		String query = "select max(news_no) from a20_track2_sv_news";
		String result = "";
		try{
	...
	//게시물 갯수 구하기
	public int getCount(){
		String query = " select count(*) from a20_track2_sv_news ";
		int result = 0;
		try{
			con = common.getConnection();
			ps  = con.prepareStatement(query);
	...
	public int insertNews(String news_no, String title, String content, String reg_id, String reg_date, String file_name_1, int hit) {
		String query = " insert into a20_track2_sv_news(news_no, title, content, reg_id, reg_date, file_name_1, hit) "+
						" values ('"+news_no+"','"+title+"','"+content+"','"+reg_id+"','"+reg_date+"','"+file_name_1+"','"+hit+"')";
    ...
    String query = " select w.news_no, w.title, w.content, m.name, to_char(w.reg_date, 'yyyy-mm-dd'), w.file_name_1, w.hit "+
				" from a20_track2_sv_news w, a20_track2_sv_member m "+
				" where w.reg_id = m.id "+
  ...
  public int newsHit(String newsNo) {
    int i = 0;
    String str = " update a20_track2_sv_news  set hit = hit+1 "+
  ...
  public int updateNews(String news_no,String title,String content,String reg_id,String reg_date,String file_name_1) {
    ...
    if(!file_name_1.equals("null")){
		query = " update a20_track2_sv_news "+
  ...
  public int deleteNews(String newsNo) {
    String str = " delete from a20_track2_sv_news "+
				" where news_no = '" + newsNo + "' ";

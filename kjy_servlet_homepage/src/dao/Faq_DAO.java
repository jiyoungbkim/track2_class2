...
public class Faq_DAO {
	...
	public String getMaxNo(){
		String query = "select max(faq_no) from a20_track2_sv_faq";
		String result = "";
		try{
	...
	//게시물 갯수 구하기
	public int getCount(){
		String query = " select count(*) from a20_track2_sv_faq ";
		int result = 0;
		try{
			con = common.getConnection();
			ps  = con.prepareStatement(query);
	...
	public int insertFaq(String faq_no, String title, String content, String reg_id, String reg_date) {
		String query = " insert into a20_track2_sv_faq(faq_no, title, content, reg_id, reg_date) "+
	...
	public int updateFaq(String faq_no,String title,String content,String reg_id,String reg_date) {
		...
		String query = " update a20_track2_sv_faq "+
	...
	public int deleteFaq(String faq_no) {
		...
		String query = " delete from a20_track2_sv_faq "+
						" where faq_no = '"+faq_no+"' ";
		System.out.println(query);
		int result = 0;
		try {

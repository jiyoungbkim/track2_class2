...
public class Member_DTO {
	...
	public Member_DTO(String id, String name, String birth, String area, String address, String telecom, String phone_1,
			String phone_2, String phone_3, String email_1, String email_2, String reg_date, String status) {
		super();
		this.id = id;
		this.name = name;
		this.birth = birth;
	...
	public Member_DTO(String id, String pw, String name, String birth, String area, String address, String telecom,
			...
			String update_date, String status) {
		super();
		this.id = id;
		this.pw = pw;
		this.name = name;

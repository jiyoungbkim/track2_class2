...
public class FaqList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("t_arrF", arrF);
		

		int fCount = dao.getCount();
		request.setAttribute("t_fCount", fCount);
		...
		RequestDispatcher rdp = request.getRequestDispatcher("/faq/faq_r.jsp");

...
<script>
	...
	function answerDelete(){
		...
		if(yn) {
			...
			fm.action = "qanda_answer_proc.jsp";
			fm.method = "post";
			fm.submit();
		}
	}
	...
	<div id="contents">
		...
		<div class="board_list">
			<table class="board_table">
				...
				<tr>
					...
					<tr>
						<th>답변</th>
						<td colspan="2"><textarea name="t_answer" class="textarea" <%if(!sessionId.equals("manager"))out.print("readonly");%>><%=dtoQ.getAnswer()%></textarea></td>
					</tr>
		...
		<div class="buttons">
				<p>
					...
					%>
					<a href="javascript:update()">답변수정</a>
					<a href="javascript:answerDelete()">답변삭제</a>
					<%
						}
					%>
				</p>

			...
			<table class="board_table">
				...
				<thead>
					<tr>
						<th>작성자</th>
						<% if(sessionId == "") { %>
							<td><input name="t_name" type="text" size="36.5%"></td>
							
						<% } else { %>
							<td><input name="t_name" type="hidden" value="<%=sessionId%>"><%=sessionId%></td>
						<% } %>
						<th>비밀번호</th>
							<td><input name="t_pw" type="password" size="36.5%"></td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<th>제목</th>
						<td colspan="3"><input name="t_title" type="text" size="90%"></td> <!---->
					</tr>
					<tr>
						<th>내용</th>
						<td colspan="3"><textarea name="t_content" class="textarea"></textarea></td> <!---->
					</tr>
				</tbody>
			</table>			
		</div>
